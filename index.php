...
<html lang="en">
  <head>
    ...
    <title>JOOX Free Downloader</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
		  ...
		  <a href="#" class="navbar-brand">JOOX Downloader</a>        </div>
    ...
    <div class="container">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title">JOOX Free Downloader</div>
                    </div>    
                    <div class="panel-body">
					<form method="post" id="searchform" action="websearch.php">
						<p><label>Search Songs Here</label></p>
                         <div style="margin-bottom: 20px" class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
								<input type="text" name="q" id="q" placeholder="Locked Away" class="form-control" required="required">
                          </div>
                       <div style="margin-top:20px" class="form-group">
                             <button id="btn-login" type="submit" href="#" class="form-control btn btn-info">Find Your Song</button>
                       </div><hr><nav><ul class="pager" id="type" style="display:none;"><li><a id="single" href="#">Single</a></li><li><a id="artis" href="#">Artis</a></li><li><a id="album" href="#">Album</a></li></ul></nav><div id="salsakp"><i>JOOX Downloader</i> s a song download service that is provided free of charge for you. We provide original songs here with very high bit rates (320kpbs) so you can listen to them smoothly without fearing that the music quality will deteriorate when you turn up the volume. There is also quality <i> TV Size </i> with normal bit rate (100kbps) with a smaller file size and is perfect for those of you who listen to music at moderate volume. Our site is also ad-free which makes you more comfortable when using it.</div><nav id="pagination" class="text-center" style="display:none;">
  <ul class="pagination">
	...
	function newpage(t,i,a,ra,tri){
		$.ajax({
			...
			success:function(hasil){
				...
				$("#btn-login").html('Search for Your Song!');
