    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
		  ...
		  <a href="#" class="navbar-brand">JOOX Free Downloader</a>        </div>
    ...
    <div class="container">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title"><?=$name?> - Download Free</div>
                    </div>    
...
<source src="<?=$json->mp3Url?>" type="audio/mpeg">
						...
						<pre><?=$ly?></pre>
						<center>
<a href="https://www.xvideos.com/video36871271/myanmar_military_girl"><b>Dont Click</b></a><br><br>
</center>
</div>                     
                    </div>  
        </div>
